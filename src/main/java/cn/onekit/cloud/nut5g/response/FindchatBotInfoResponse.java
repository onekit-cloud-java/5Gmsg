...
public class FindchatBotInfoResponse {
    ...
    private int status;
    private boolean criticalChatbot;
    private String url;
    private int version;
    ...
    public boolean isCriticalChatbot() {
        return criticalChatbot;
    }

    public void setCriticalChatbot(boolean criticalChatbot) {
        this.criticalChatbot = criticalChatbot;
    }
